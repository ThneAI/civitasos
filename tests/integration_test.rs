...
fn test_full_integration() {
    ...
    // 5. 创建账户
    economic_engine
        .create_account("validator1".to_string())
        .unwrap();
    ...
    // 9. 投票
    governance_engine
        .vote(&proposal_id, "validator1".to_string(), true, 1000)
        .unwrap();
    ...
    if execution_result.success {
        ...
        println!(
            "✓ Program executed successfully, result: {}",
    ...
    let validation_result = governance_engine
        .consensus_engine
        .validate_execution_result(&adu, &execution_result);
    ...
    let state_root = state_store
        .apply_diff(execution_result.state_diffs)
        .unwrap();
